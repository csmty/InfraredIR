export PYTHONPATH="/data/matengyu/code/@submit/Infrared/CVPR26/ReleaseCode/mty/InfraredIR/src:/data/matengyu/code/@submit/Infrared/CVPR26/ReleaseCode/mty/InfraredIR:$PYTHONPATH"
